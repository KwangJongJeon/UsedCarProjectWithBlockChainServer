...
// @route PUT api/user/putAddress/:id
router.put("/putAddress/:id", (req, res) => {
  console.log('put request to /api/user/putAddress/:id api is arrived!');

  const address = req.body.address;
  console.log(address)

  User.findOneAndUpdate({ email: req.params.id }, { address: address})
    .then(userValue => res.json({ msg: 'Updated Successfully'}))
    .catch(err => 
